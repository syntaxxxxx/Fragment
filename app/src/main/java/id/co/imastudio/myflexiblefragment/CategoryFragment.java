...
public class CategoryFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_detail_category){
            ...
            // Kirim data menggunakan obyek bundle
            Bundle mBundle = new Bundle();
            mBundle.putString(DetailCategoryFragment.EXTRA_NAME, "Pindah bawa data");
            // Kirim data menggunakan setter dan getter
            String description = "Use setter getter";
